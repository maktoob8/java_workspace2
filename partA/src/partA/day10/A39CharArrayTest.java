...
public class A39CharArrayTest {
   ...
   public static void main(String[] args) {
      ...
      System.out.println("정수타입 배열 이름으로 print");
      System.out.println(nums);
      System.out.println("문자타입 배열 이름으로 print");
      System.out.println(chs);   //char 배열은 문자열과 유사하게 다룰 수 있다.
      ...
      System.out.println(tempArr); //tempArr을 출력을 위해 자동으로 String 변환
      ...
      //[C@7a79be86에서 7a79be86 는 해시코드값이고 해시함수를 통해 만들어지는 4바이트 값.
